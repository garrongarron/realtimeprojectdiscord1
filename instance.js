...
const realm_1 = require("peer/dist/src/models/realm");
const checkBrokenConnections_1 = require("peer/dist/src/services/checkBrokenConnections");
const messagesExpire_1 = require("peer/dist/src/services/messagesExpire");
const webSocketServer_1 = require("peer/dist/src/services/webSocketServer");
const messageHandler_1 = require("peer/dist/src/messageHandler");
const api_1 = require("peer/dist/src/api");
const createInstance = ({ app, server, options }) => {
    ...
    wss.on("connection", (client) => {
        ...
        app.emit("connection", client, realm);// we add realm as third parameter
    });
    ...
    wss.on("close", (client) => {
        app.emit("disconnect", client, realm);// we add realm as third parameter
    });
    wss.on("error", (error) => {
